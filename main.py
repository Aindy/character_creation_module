...
def attack(char_name: str, char_class: str) -> str:
    """Generate random attack depending on character class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Generate random defence depending on character class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Generate random special skill depending on character class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Interface for begin to play and skip training episode."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Start dialog for opportunity to choose character."""
